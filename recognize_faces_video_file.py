...
while True:
	...
	time2 = datetime.now()
	timeSpentProcessing = timeSpentProcessing + (time2.timestamp()-time1.timestamp())
	names = []
...
print("Total Time Spent Processing: "+ str(timeSpentProcessing))
print("Total Run Time(s): "+ str(datetime.now().timestamp() - startTime.timestamp()))
print("FPS: "+ str(num_frames/(datetime.now().timestamp() - startTime.timestamp())))
stream.release()
